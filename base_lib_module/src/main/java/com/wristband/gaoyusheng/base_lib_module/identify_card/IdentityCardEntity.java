...
public class IdentityCardEntity implements Serializable {
    ...
    private static List<String> nationList = Lists.newArrayList(
            "汉",
            "蒙古",
            "回",
            "藏",
    ...
    public void setEncodeBitmapStr(Bitmap bitmap) {
        this.encodeBitmapStr = getBase64EncodePhoto(bitmap, 100);
        this.encodeBitmapForUploadStr = getBase64EncodePhoto(bitmap, 50);
    }
